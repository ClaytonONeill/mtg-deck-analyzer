          ...
          {activeTab === "wishlist" && (
            <>
              <button
                onClick={handleConfirm}
                disabled={!selected}
                className={`w-full font-semibold text-sm py-2.5 rounded-lg transition-colors mt-2 col-span-full ${
                  selected
                  ...
                  deckWishlist.map((entry) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={!legal}
                        className="flex flex-col items-center gap-2 bg-slate-800 border rounded-xl p-2 text-center transition-colors"
                        style={{
                          borderColor:
